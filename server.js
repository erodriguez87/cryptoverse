...
db.sequelize.sync({ force: true }).then(function() {
  ...
  db.Learn.bulkCreate([
    ...
    features: 'limited, somewhat private, well known', 
    markets: 'currency', 
    ...
    shortDesc: 'Ethereum was founded as a basic currency and blockchain for smart contracts and decentralized digital applications.', 
    features: 'application platform, contracts', 
    markets: 'contracts,currency,application', 
    disadvantages: 'scaling issues', 
    started: '2014',
    }, {
    id: '3', 
    cryptoId: 'XRP', 
    ...
    shortDesc: 'A blockchain established to facilitate transfer of money across country borders. The company works mainly with banks and uses the XRP token to immediately transfer money.', 
    features: 'baking, transfery', 
    markets: 'contracts,currency,application', 
    disadvantages: 'centralized, disliked by crypto community for centralization', 
    started: '2014',
    }, {
    id: '4', 
    cryptoId: 'VEN', 
